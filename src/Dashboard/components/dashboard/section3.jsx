                            ...
                            <div className="row">
                                <div className="time mt-4 col-12 text-center d-flex justify-content-center">
                                    <div className="progress progress-bar-vertical first ">
                                        <div className="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0"
                                            aria-valuemax="100" style={{ height: '30%' }}></div>
                                    </div>
                                    <div className="progress progress-bar-vertical">
                                        <div className="progress-bar progress-bar-danger " role="progressbar" aria-valuenow="60"
                                            aria-valuemin="0" aria-valuemax="100" style={{ height: '60%' }}></div>
                                    </div>
                                    <div className="progress progress-bar-vertical">
                                ...
                                <div className="col-12">
                                    <input type="button" className="btn-pink btn btn-sm mt-4" value="Weekly" />
                                </div>
                            </div>
